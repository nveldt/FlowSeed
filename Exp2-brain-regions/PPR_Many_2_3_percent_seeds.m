% Running PPR push experiments with the two largest seed set sizes
...
for seedtype = 2:3
    ...
    for alpha = alphas
        outputfile = strcat('PPR_Train_Output/Seed_',num2str(seedtype),'per_alpha_',num2str(alpha*100),'.txt');
        ...
        fclose(fid);
        save(strcat('PPR_Train_Output/Seed_',num2str(seedtype),'per_alpha_',num2str(alpha*100),'sets_stats'),'sets_tol_7','stats_tol_7','sets_tol_8','stats_tol_8','sets_tol_9','stats_tol_9','sets_tol_10','stats_tol_10')
    end
end